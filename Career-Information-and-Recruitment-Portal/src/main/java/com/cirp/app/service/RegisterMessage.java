...
public class RegisterMessage {
	public static void registerMessage(RedirectAttributes redirectAttributes, User user_exists, User email_exists, String type) {
		if (user_exists != null) {
			...
			redirectAttributes.addFlashAttribute("message","Successfully registered new student!");
		} else {
